...
{
    public partial class fr_ThongKe_SP : Form
    {
        public fr_ThongKe_SP()
        {
            InitializeComponent();
        }
        ...
        private void xuatbaocao_Click(object sender, EventArgs e)
        {
            ...
            exRange.Range["A1:B1"].Value = "Cafe Phúc Cường Thịnh";
            ...
            sql = @"SELECT tb_CTHDB.masp, SUM( tb_CTHDB.soluong) AS SL FROM tb_HDB INNER JOIN tb_CTHDB ON tb_HDB.mahdb = tb_CTHDB.mahdb where tb_HDB.ngayban BETWEEN '" + d1.Text + "' AND '" + d2.Text + "' group by tb_CTHDB.masp order by SUM( tb_CTHDB.soluong) DESC";
        ...
        private void fr_ThongKe_SP_Load(object sender, EventArgs e)
        {
