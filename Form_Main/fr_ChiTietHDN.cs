...
{
    public partial class fr_ChiTietHDN : Form
    {
        public fr_ChiTietHDN()
        {
            InitializeComponent();
        }

        Prc_tb_CTHDN thucthi = new Prc_tb_CTHDN();
        Connection cn = new Connection();
        Class_tb_CTHDN ck = new Class_tb_CTHDN();
        bool themmoi;
        int dong = 0;
        ...
        private void fr_ChiTietHDN_Load(object sender, EventArgs e)
        {
            cbhd.Text = sohdn;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            exRange.Range["A1:F1"].Value = "Cafe Phúc Cường Thịnh";
            exRange.Range["A2:B2"].MergeCells = true;
            exRange.Range["A2:B2"].HorizontalAlignment = COMExcel.XlHAlign.xlHAlignCenter;
            exRange.Range["A2:B2"].Value = "Quận Tân Phú, HCM";
            ...
            sql = @"SELECT tb_Sanpham.tensp, tb_CTHDN.soluong, tb_CTHDN.dongia, tb_CTHDN.khuyenmai, tb_CTHDN.thanhtien FROM tb_CTHDN INNER JOIN tb_Sanpham ON tb_CTHDN.masp = tb_Sanpham.masp AND tb_CTHDN.masp = tb_Sanpham.masp where tb_CTHDN.mahdn='" + cbhd.Text + "'";
            ...
            exRange.Font.Bold = true;
            exRange.Value2 = tblThongtinHang.Rows[0][4].ToString();////////////////////////////
